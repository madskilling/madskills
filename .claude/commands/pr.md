---
description: Create a pull request for the current work, or update an existing one.
argument-hint: [PR_TITLE="<title>"] [BRANCH_NAME="<branch>"]
---
...
4. **If on `main`**, create a new branch:
   - Use $BRANCH_NAME as branch name if provided
