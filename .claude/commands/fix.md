...
argument-hint: [ISSUENUMBER=<number>]
---

1. Fetch the issue details: `gh issue view $ISSUENUMBER`
2. Summarize the issue: what's the problem, expected behavior, reproduction steps
3. Create a branch: `git checkout -b fix-$ISSUENUMBER` (or a more descriptive name based on the issue)
...
The PR should include "Fixes #$ISSUENUMBER" in the description to auto-close the issue on merge.
